...
def plot_3d_box(img, cam_to_img, ry, dimension, center, color = cv_colors.GREEN.value, thickness = 2):
...
def plot_2d_box(img, box_2d):
    ...
    # plot the 2d box
    cv2.line(img, pt1, pt2, cv_colors.BLUE.value, 1)
    cv2.line(img, pt2, pt3, cv_colors.BLUE.value, 1)
    cv2.line(img, pt3, pt4, cv_colors.BLUE.value, 1)
    cv2.line(img, pt4, pt1, cv_colors.BLUE.value, 1)
